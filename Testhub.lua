...
Window = Library:CreateWindow({
    Title = "Ziner hub",
    Desc = "| Vevison 2",
    Image = "rbxassetid://88031262069243"
})
...
-- ==========================================
-- ========================================================
-- HELPER: Inject OnChanged into UI element objects
-- ========================================================
...
-- ==========================================
-- CREATE TABS WITH WRAPPER
-- ==========================================
Tabs = {
    ["Info"]     = wrapTab(Window:AddTab("Tab Info")),
    ["Main"]     = wrapTab(Window:AddTab("Tab Farm")),
    ["Sea"]      = wrapTab(Window:AddTab("Tab Event")),
    ["Item"]     = wrapTab(Window:AddTab("Tab Items")),
    ["Setting"]  = wrapTab(Window:AddTab("Tab Settings")),
    ["Status"]   = wrapTab(Window:AddTab("Tab Webhook")),
    ["Stats"]    = wrapTab(Window:AddTab("Tab Stats")),
    ["Player"]   = wrapTab(Window:AddTab("Tab Player")),
    ["Teleport"] = wrapTab(Window:AddTab("Tab Teleport")),
    ["Visual"]   = wrapTab(Window:AddTab("Tab Visual")),
    ["Fruit"]    = wrapTab(Window:AddTab("Tab Devil Fruit")),
    ["Raid"]     = wrapTab(Window:AddTab("Tab Raid")),
    ["Race"]     = wrapTab(Window:AddTab("Tab Race")),
    ["Shop"]     = wrapTab(Window:AddTab("Tab Shop")),
    ["Misc"]     = wrapTab(Window:AddTab("Tab Misc")),
}
...
Library:Notify({
    Title = "Ziner Hub",
    Description = "Welcome! Hub loaded successfully.\nPress the button on the left side of the screen to open the GUI.",
    Duration = 4
})
...
Tabs.Info:AddParagraph({
    ...
    ["Description"] = "Skill: Del supported"
})
local v252 = nil
...
-- [SetValue skipped - Library không cần]
Tabs.Setting:AddSection("Mastery Skills")
...
Tabs.Fruit:AddSection("Devil Fruit")
...
Tabs.Race:AddSection("Race Upgrade")
Tabs.Race:AddButton({
    ["Title"] = "Đền Thời Gian",
    ["Callback"] = function()
...
-- ========== NÂNG ĐIỂM KỸ NĂNG ==========
Tabs.Setting:AddSection("Skill Points")
...
Tabs.Setting:AddToggle("ToggleSPFruit", {["Title"] = "Devil Fruit", ["Default"] = false}):OnChanged(function(v) _spFruit = v end)
spawn(function()
...
-- ========== KỸ NĂNG ĐẶC BIỆT ==========
Tabs.Setting:AddSection("Special Skills")
...
-- ========== FPS BOOST ==========
Tabs.Misc:AddSection("FPS & Performance")
Tabs.Misc:AddButton({
    ["Title"] = "FPS Boost",
    ["Callback"] = function()
        pcall(function()
...
-- ===============================================================
print('✅ Ziner Hub - All features loaded!')
