...
local FolderName = "Ziner hub | RC V2"
...
local Window = bearlib:MakeWindow({
    Title = "Ziner Hub | RC V2",
    SubTitle = "by Kaibeo",
    SaveFolder = true,
    Image = "88031262069243"
})
...
v0:AddProfile({
    ...
    Avatar = "rbxassetid://88031262069243", 
...
local discordContainer = v0:AddDiscordInvite({
    -- Card 1
    {
        ...
        500,
        1500,
        "https://www.tiktok.com/@kaibeo26?_r=1&_t=ZS-95QTTQrbj77"
    },
    -- Card 2
    {
...
-- =========================================================
-- AUTO FISHING SYSTEM (Ported from Ziner X Ter)
-- =========================================================
        ...
        pcall(function()
            while wait(Sec) do
                if _G.Auto_Rainbow_Haki then
                    -- Copy logic Rainbow Haki từ file Ziner.txt (dòng 2058-2154) vào đây nếu cần
